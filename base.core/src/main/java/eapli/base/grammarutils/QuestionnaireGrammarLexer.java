...
public class QuestionnaireGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"QUESTIONNAIRE_ID", "SECTION_DELIMITER", "OBLIGATORINESS_TITLE", "OBLIGATORINESS_OPTIONS", 
			"QUETION_DELIMITER1", "QUETION_DELIMITER2", "INSTRUCTION_TITLE", "TYPE_TITLE", 
			"SELECTION_TYPE_TITLE", "TABLE_TYPE_TITLE", "TABLE_DELIMITER", "END_TABLE_DELIMITER", 
			"INSERTION_TYPE_TITLE", "ANSWER_TITLE", "TITLE", "WORD", "NUMBER", "SPACE", 
			"END_SENTENCE_PUNCTUATION", "PUNCTUATION", "DELIMITERS", "SPECIAL_CHARACTERS", 
			"NEWLINE", "SENTENCE"
		};
	}
	...
	public QuestionnaireGrammarLexer(CharStream input) {
		super(input);
