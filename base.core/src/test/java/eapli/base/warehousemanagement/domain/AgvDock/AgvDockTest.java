...
public class AgvDockTest {
    ...
    public void ensureMustHaveValidId() {
        new AgvDock(new AgvDockId(""), begin, end, depth, accessibility, warehouse);
    }

    @Test
    public void ensureValidAgvDock() {
        assertNotNull(agvDock);
    }

    @Test
    public void identity() {
        assertEquals(agvDockId, agvDock.identity());
    }

    @Test
    public void toStringTest(){
        String toString = "Agv dock id: 123, begin square: length: 5 width: 1, end square: length: 2 width: 3, depth square: length: 3 width: 8, accessibility: w+";
        assertEquals(agvDock.toString(), toString);
    }
}