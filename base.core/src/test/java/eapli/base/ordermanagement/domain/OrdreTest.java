...
public class OrdreTest {
    ...
    private Customer customer = registerCustomer();
    ...
    @Test
    public void ensureCreatesValidOrder(){
        Ordre order = new Ordre(orderId, customer, billingAddress, deliveryAddress, paymentMethod, price, weight);
        assertNotNull(order);
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureMustHaveValidOrderId(){
        new Ordre(null, customer, billingAddress, deliveryAddress, paymentMethod, price, weight);
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureMustHaveValidCustomer(){
        new Ordre(orderId, null, billingAddress, deliveryAddress, paymentMethod, price, weight);
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureMustHaveValidBillingAddress(){
        new Ordre(orderId, customer, null, deliveryAddress, paymentMethod, price, weight);
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureCreatesValidDeliveryAddress(){
        new Ordre(orderId, customer, billingAddress, null, paymentMethod, price, weight);
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureCreatesValidPaymentMethod(){
        new Ordre(orderId, customer, billingAddress, deliveryAddress, null, price, weight);
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureCreatesValidPrice(){
        new Ordre(orderId, customer, billingAddress, deliveryAddress, paymentMethod, null, weight);
    }

    @Test(expected = IllegalArgumentException.class)
    public void ensureCreatesValidWeight(){
        new Ordre(orderId, customer, billingAddress, deliveryAddress, paymentMethod, price, null);
    }
}